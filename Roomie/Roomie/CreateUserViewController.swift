...
class CreateUserViewController: UIViewController, UITextFieldDelegate {
    ...
    func createUser()
    {
        let user = RoomieUser(userName: usernameField.text!, houseID: houseIDField.text!, firstName: firstName, lastName: lastName, email: email, profilePictureURL: profilePicURL, myTasks: [RoomieEvent](), userID: googleUser.userID)
